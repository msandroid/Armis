  ...
  if (hasError) {
    return (
      <div 
        ...
        role="alert"
        aria-label="動画読み込みエラー"
      >
        <div className="text-center text-white">
          <AlertCircle className="w-12 h-12 mx-auto mb-4 text-red-400" />
          <div className="text-lg font-semibold mb-2">動画の読み込みに失敗しました</div>
          <div className="text-sm text-gray-400 mb-4">動画ファイルを確認してください</div>
          <button
