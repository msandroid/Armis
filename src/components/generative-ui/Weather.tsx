      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">気温</span>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">湿度</span>
          </div>
          <div className="text-2xl font-bold text-gray-800 dark:text-gray-200">
            {humidity}%
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">風速</span>
          </div>
          <div className="text-2xl font-bold text-gray-800 dark:text-gray-200">
            {windSpeed} km/h
          </div>
