...
`
    ...
    let response: any
    if ('generateResponse' in this.llmService) {
      response = await (this.llmService as LlamaService).generateResponse(codePrompt)
    } else {
      response = await (this.llmService as OllamaService).generate(codePrompt)
    }
...
`
    ...
    let response: any
    if ('generateResponse' in this.llmService) {
      response = await (this.llmService as LlamaService).generateResponse(filePrompt)
    } else {
      response = await (this.llmService as OllamaService).generate(filePrompt)
    }
...
`
    ...
    let response: any
    if ('generateResponse' in this.llmService) {
      response = await (this.llmService as LlamaService).generateResponse(dataPrompt)
    } else {
      response = await (this.llmService as OllamaService).generate(dataPrompt)
    }
...
`
    ...
    let response: any
    if ('generateResponse' in this.llmService) {
      response = await (this.llmService as LlamaService).generateResponse(creativePrompt)
    } else {
      response = await (this.llmService as OllamaService).generate(creativePrompt)
    }
...
`
    ...
    let response: any
    if ('generateResponse' in this.llmService) {
      response = await (this.llmService as LlamaService).generateResponse(thinkingPrompt)
    } else {
      response = await (this.llmService as OllamaService).generate(thinkingPrompt)
    }
...
export class GeneralAgent implements LangChainAgent {
  ...
  async execute(input: string, context?: Record<string, any>): Promise<AgentResponse> {
    let response: any
    if ('generateResponse' in this.llmService) {
      response = await (this.llmService as LlamaService).generateResponse(input)
    } else {
      response = await (this.llmService as OllamaService).generate(input)
    }
