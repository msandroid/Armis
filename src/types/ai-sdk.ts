...
export const AVAILABLE_PROVIDERS: AIProvider[] = [
  {
    id: 'runway',
    name: 'Runway ML',
    description: 'Runway ML AI video generation models',
    apiKeyName: 'RUNWAY_API_KEY',
    requiresApiKey: true,
    ...
    models: [
      ...
      },
      {
        ...
        provider: 'Runway ML',
        maxOutputTokens: 0,
        description: 'Fast AI video generation model',
        capabilities: {
          imageInput: true,
          objectGeneration: true,
          toolUsage: false,
  ...
  },
  {
    id: 'veo',
    name: 'Veo',
    description: 'Veo AI video generation models',
    apiKeyName: 'VEO_API_KEY',
    requiresApiKey: true,
    baseUrl: 'https://api.veo.ai/v1',
    models: [
      {
        id: 'veo-1',
        name: 'Veo 1',
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        provider: 'Google Generative AI',
        maxTokens: 1000000,
        description: 'Ultra-fast and cost-effective Gemini 2.5 model with optimized streaming',
        capabilities: {
          imageInput: true,
          objectGeneration: true,
          toolUsage: true,
  ...
  },
  {
    ...
    models: [
      // Llama 3.1 シリーズ
      {
        ...
        maxTokens: 32768,
        description: 'High-performance Llama 3.1 8B model',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      // Additional LLM Models (追加の言語モデル)
      {
        id: 'gpt-oss-120b',
        name: 'GPT-OSS 120B',
        provider: 'Fireworks.ai',
        maxTokens: 32768,
        description: 'Open weight model designed for reasoning and agentic tasks',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      },
      {
        ...
        provider: 'Fireworks.ai',
        maxTokens: 32768,
        description: 'Open weight model for versatile developer use cases',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      },
      {
        ...
        provider: 'Fireworks.ai',
        maxTokens: 32768,
        description: 'Alibaba\'s code generation model',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      },
      {
        ...
        provider: 'Fireworks.ai',
        maxTokens: 32768,
        description: 'Fast code generation model from Alibaba',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        provider: 'Llama.cpp',
        maxTokens: 32768,
        description: 'OpenAI GPT-OSS-20B model optimized with Unsloth, GGUF format for powerful reasoning, agentic tasks, and versatile developer use cases',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      // Gemma 3 シリーズ
      {
        ...
        provider: 'Ollama',
        maxTokens: 32768,
        description: 'Gemma 3 model (defaults to 1B variant)',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      {
        id: 'qwen3:0.6b',
        name: 'Qwen 3 0.6B (Ollama)',
        provider: 'Ollama',
        maxTokens: 32768,
        description: 'Ultra-compact Qwen 3 model via Ollama',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      {
        id: 'qwen3:1.7b',
        name: 'Qwen 3 1.7B (Ollama)',
        provider: 'Ollama',
        maxTokens: 32768,
        description: 'Compact Qwen 3 model via Ollama',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      },
      {
        ...
        provider: 'Ollama',
        maxTokens: 32768,
        description: 'Balanced Qwen 3 model via Ollama',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      },
      {
        ...
        provider: 'Ollama',
        maxTokens: 32768,
        description: 'High-performance Qwen 3 model via Ollama',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      },
      {
        ...
        provider: 'Ollama',
        maxTokens: 32768,
        description: 'Large Qwen 3 model via Ollama',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      },
      {
        ...
        provider: 'Ollama',
        maxTokens: 32768,
        description: 'Very large Qwen 3 model via Ollama',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      },
      {
        ...
        provider: 'Ollama',
        maxTokens: 32768,
        description: 'Large Qwen 3 model with enhanced capabilities via Ollama',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      {
        id: 'qwen3:235b',
        name: 'Qwen 3 235B (Ollama)',
        provider: 'Ollama',
        maxTokens: 32768,
        description: 'Massive Qwen 3 model for complex reasoning via Ollama',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
  ...
  },
  {
    id: 'llama-cpp',
    name: 'Llama.cpp',
    description: 'Local LLM inference using llama.cpp with GGUF models',
    apiKeyName: 'LLAMA_CPP_API_KEY',
    requiresApiKey: false,
    models: [
      {
        id: 'llama-2-7b-chat',
      ...
      },
      {
        ...
        provider: 'Llama.cpp',
        maxTokens: 4096,
        description: '13B parameter chat model',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: false,
      ...
      },
      {
        ...
        provider: 'Llama.cpp',
        maxTokens: 8192,
        description: '7B parameter instruction model',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: false,
      ...
      },
      {
        ...
        provider: 'Llama.cpp',
        maxTokens: 32768,
        description: '7B parameter instruction model with long context',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: false,
      ...
      },
      {
        ...
        name: 'Qwen2.5-Omni 3B GGUF (Any-to-Any)',
        provider: 'Llama.cpp',
        maxTokens: 32768,
        description: '3.4B parameter any-to-any multimodal model supporting text, image, audio, video input/output with real-time speech generation',
        capabilities: {
          imageInput: true,
          objectGeneration: true,
          toolUsage: false,
      ...
      {
        id: 'qwen2.5-omni-7b-gguf',
        name: 'Qwen2.5-Omni 7B GGUF (Any-to-Any)',
        provider: 'Llama.cpp',
        maxTokens: 32768,
        description: '7.62B parameter any-to-any multimodal model supporting text, image, audio, video input/output with real-time speech generation',
        capabilities: {
          imageInput: true,
          objectGeneration: true,
          toolUsage: false,
      ...
      },
      {
        ...
        provider: 'Llama.cpp',
        maxTokens: 32768,
        description: 'OpenAI GPT-OSS-20B model for powerful reasoning, agentic tasks, and versatile developer use cases',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      // Qwen 3 シリーズ (Llama.cpp)
      {
        id: 'qwen3-0.6b-gguf',
        name: 'Qwen3 0.6B (Llama.cpp)',
        provider: 'Llama.cpp',
        maxTokens: 8192,
      ...
      {
        id: 'qwen3-4b-gguf',
        name: 'Qwen3 4B Instruct (Llama.cpp)',
        provider: 'Llama.cpp',
        maxTokens: 8192,
      ...
      {
        id: 'qwen3-30b-gguf',
        name: 'Qwen3 30B Instruct (Llama.cpp)',
        provider: 'Llama.cpp',
        maxTokens: 8192,
  ...
  },
  {
    id: 'huggingface',
    name: 'Hugging Face',
    description: 'Hugging Face Inference API for models and TTS',
    apiKeyName: 'HUGGINGFACE_API_KEY',
    requiresApiKey: true,
    baseUrl: 'https://api-inference.huggingface.co',
    models: [
      // Qwen 3 シリーズ (Hugging Face)
      {
        id: 'qwen3-0.6b-hf',
        name: 'Qwen3 0.6B (Hugging Face)',
        provider: 'Hugging Face',
        maxTokens: 8192,
        description: 'Qwen3 0.6B model via Hugging Face Inference API',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      {
        id: 'qwen3-1.7b-hf',
        name: 'Qwen3 1.7B (Hugging Face)',
        provider: 'Hugging Face',
        maxTokens: 8192,
        description: 'Qwen3 1.7B model via Hugging Face Inference API',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      {
        id: 'qwen3-4b-hf',
        name: 'Qwen3 4B Instruct (Hugging Face)',
        provider: 'Hugging Face',
        maxTokens: 8192,
        description: 'Qwen3 4B Instruct model via Hugging Face Inference API',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      {
        id: 'qwen3-8b-hf',
        name: 'Qwen3 8B (Hugging Face)',
        provider: 'Hugging Face',
        maxTokens: 8192,
        description: 'Qwen3 8B model via Hugging Face Inference API',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
      ...
      {
        id: 'qwen3-30b-hf',
        name: 'Qwen3 30B Instruct (Hugging Face)',
        provider: 'Hugging Face',
        maxTokens: 8192,
        description: 'Qwen3 30B Instruct model via Hugging Face Inference API',
        capabilities: {
          imageInput: false,
          objectGeneration: true,
          toolUsage: true,
  ...
  },
  {
    id: 'inworld',
    name: 'Inworld AI',
    description: 'Inworld AI TTS models for high-quality text-to-speech synthesis',
    ...
    models: [
      ...
      },
      {
        ...
        provider: 'Inworld AI',
        maxTokens: 4096,
        description: 'Neutral voice option',
        capabilities: {
          imageInput: false,
          objectGeneration: false,
          toolUsage: false,
  ...
  {
    id: 'local-inworld',
    name: 'Local Inworld AI',
    description: 'Local Inworld TTS models for completely free, offline text-to-speech synthesis',
    apiKeyName: '',
    requiresApiKey: false,
    models: [
      {
        id: 'tts-1-local',
        name: 'TTS-1 Local',
        provider: 'Local Inworld AI',
        maxTokens: 4096,
        description: 'Local high-quality text-to-speech model (free, offline)',
        capabilities: {
          imageInput: false,
          objectGeneration: false,
          toolUsage: false,
      ...
      {
        id: 'tts-1-max-local',
        name: 'TTS-1 Max Local',
        provider: 'Local Inworld AI',
        maxTokens: 4096,
        description: 'Local maximum quality text-to-speech model (free, offline)',
        capabilities: {
          imageInput: false,
          objectGeneration: false,
          toolUsage: false,
